...
export default function AdminAnalytics() {
  ...
  const cards = [
    { label:"Total Sellers", value:stats.totalSellers, link:"/admin/sellers?role=SELLER" },
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="bg-white border border-gray-200 rounded-xl p-6">
          ...
          <div className="space-y-2">
            <Link href="/admin/sellers?action=create" className="block py-2 px-4 text-sm text-gray-700 hover:bg-blue-50 hover:text-blue-700 rounded-lg transition-colors">+ Create Seller Account</Link>
            <Link href="/admin/agents?action=create" className="block py-2 px-4 text-sm text-gray-700 hover:bg-blue-50 hover:text-blue-700 rounded-lg transition-colors">+ Create Agent Account</Link>
            <Link href="/admin/sellers?action=create&role=ADMIN" className="block py-2 px-4 text-sm text-gray-700 hover:bg-blue-50 hover:text-blue-700 rounded-lg transition-colors">+ Create Admin Account</Link>
          </div>
        </div>
        <div className="bg-white border border-gray-200 rounded-xl p-6">
